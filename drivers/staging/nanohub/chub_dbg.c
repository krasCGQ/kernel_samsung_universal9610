...
#ifdef CONFIG_SENSORS_SSP
		ssp_dump_write_file(ipc->ssp_data, reason, p_dbg_dump->time, 
		p_dbg_dump, sizeof(struct dbg_dump), 
		&p_dbg_dump->sram[p_dbg_dump->sram_start], ipc_get_chub_mem_size(), p_dbg_dump);
