...
#ifdef CAMERA_REAR2
			&& crc32_check_list[SENSOR_POSITION_REAR3][CRC32_CHECK_FACTORY] == true
#endif
		) {
...
#ifdef CAMERA_REAR2
			if (!crc32_check_list[SENSOR_POSITION_REAR3][CRC32_CHECK_FACTORY])
		...
		struct device_attribute *attr, char *buf)
{
	...
	if(crc32_check_list[position][CRC32_CHECK_FW_VER] == true) {
		...
		if (crc32_check_fw && crc32_check_factory && crc32_check_setfile
#ifdef CAMERA_REAR2
			&& crc32_check_list[SENSOR_POSITION_REAR3][CRC32_CHECK_FACTORY]
#endif
		) {
...
#ifdef CAMERA_REAR2
			|| !check_latest_cam_module[SENSOR_POSITION_REAR3]
#endif
			) {
...
#ifdef CAMERA_REAR2
				|| !check_final_cam_module[SENSOR_POSITION_REAR3]
#endif
			) {
...
static ssize_t camera_rear3_tilt_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_tilt_show(buf, SENSOR_POSITION_REAR2);
}
