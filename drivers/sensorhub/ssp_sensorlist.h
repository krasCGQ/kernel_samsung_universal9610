...
#define SENSOR_INFO_PROXIMITY                                   {"proximity_sensor", PROXIMITY_ENABLED, REPORT_MODE_ON_CHANGE, 3, 3}
...
#define SENSOR_INFO_PROXIMITY_RAW                               {"", PROXIMITY_ENABLED, REPORT_MODE_CONTINUOUS, 2, 0}
